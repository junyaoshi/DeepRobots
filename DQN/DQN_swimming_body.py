...
agent = DQNAgent(epsilon_decay=0.9999987, memory_size=20000, actions_params=(-pi / 8, pi / 8, pi / 8),
                 learning_rate=0.001)

# Perform DQN
agent, num_episodes, avg_rewards, \
std_rewards, avg_losses, std_losses = perform_DQN(agent, episodes=5000, iterations=200, batch_size=8, C=200)
