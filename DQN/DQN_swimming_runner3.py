...
from math import pi
from utils.learning_helper import forward_reward_function, backward_reward_function, upward_reward_function, left_reward_function
...
def main():
    ...
    trial_name = 'DQN_swimming_left_1000000_iters'
    trial_num = 35
