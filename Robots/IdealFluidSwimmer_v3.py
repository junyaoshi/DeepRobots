...
class IdealFluidSwimmer(object):
    ...
    def set_theta(self, theta):
        self.theta = theta
        self.state = (theta, self.a1, self.a2)
        return self.state
...
if __name__ == "__main__":
    ...
    robot = IdealFluidSwimmer(a1=0, a2=0, no_joint_limit = True, t_interval=1)
    ...
    #generate_csv(robot_params, "./" + "result.csv")
    ...
    plt.plot(time, a1dotl)
    plt.ylabel('a1dot')
    plt.show()

    plt.plot(time, a2dotl)
    plt.ylabel('a2dot')
    plt.show()
