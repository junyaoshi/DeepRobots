...
class ThreeLinkRobot(object):
    ...
    def __init__(self,
                 ...
                 t_interval=0.001,
                 timestep=1,
                 singularity_tolerance=1e-3,
                 singularity_offset=1e-3):
        """
        ...
        self.singularity_tolerance = singularity_tolerance
    ...
    def robot(self, v, t, da1, da2):
        ...
        #         a1 += self.singularity_offset
        #         a2 -= self.singularity_offset
        #     else:
        #         a1 -= self.singularity_offset
        #         a2 += self.singularity_offset
    ...
    def singularity_event(self, a1, a2):
        return np.abs(a1 - a2) < self.singularity_tolerance
...
if __name__ == "__main__":
    ...
    robot = ThreeLinkRobot(t_interval=1, a1=pi/8, a2=-pi/8)
    ...
    plt.savefig('plots/a1')
    plt.close()

    plt.plot(time, a2)
    plt.ylabel('a2 displacements')
    plt.savefig('plots/a2')
    plt.close()
