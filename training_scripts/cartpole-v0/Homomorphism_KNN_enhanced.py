...
Shared.plot(f'Homomorphism_KNN_enhanced. weight, K, dimension:{weight, dimension}' + Shared.title(params), 'total rewards', 'episodes', rewards, episodes, 'DQN_symmetry.csv')