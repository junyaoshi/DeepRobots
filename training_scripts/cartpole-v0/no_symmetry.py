...
plot_csv('no symmetry(batch 8, no reward shape)', 'DQN_no_symmetry.csv')
...
plot('no symmetry(batch 8, no reward shape)', 'total rewards', 'episodes', rewards, episodes, 'DQN_no_symmetry.csv')