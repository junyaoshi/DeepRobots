...
trial_name = "trial_9.18"
results_dir = os.path.join("results", "LearningResults", "SAC_IdealFluidSwimmerWithSpring", trial_name)
tensorboard_dir = os.path.join(results_dir, "tensorboard")

model = SAC(MlpPolicy, vec_env, verbose=1, tensorboard_log=tensorboard_dir)
model.learn(total_timesteps=50, tb_log_name="trial_run")
