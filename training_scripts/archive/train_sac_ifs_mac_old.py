...
model.learn(total_timesteps=params['total_timesteps'], tb_log_name="trial_run", reset_theta = True, reset_freq = 500)

env = vec_env.envs[0]
obs_prev = env.reset_w_theta(pi/2)
#obs_prev = env.reset()
